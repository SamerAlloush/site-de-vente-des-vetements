...
$stmt = $pdo->prepare('SELECT * FROM products WHERE sexe = "Men" ORDER BY dateadded DESC /*LIMIT ?,?*/');
...
$total_products = $pdo->query('SELECT * FROM products WHERE sexe = "Men" ')->rowCount();
?>
