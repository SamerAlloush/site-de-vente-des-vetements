...
$stmt = $pdo->prepare('SELECT * FROM products WHERE sexe = "Women" ORDER BY dateadded DESC /*LIMIT ?,?*/');
...
$total_products = $pdo->query('SELECT * FROM products WHERE sexe = "Women" ')->rowCount();
?>
...
<?=template_header('Women Products')?>
